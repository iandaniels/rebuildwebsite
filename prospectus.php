...
<body>
    ...
    <div class="container">
		<div>
			<img class="img-responsive" src="images/banner_altprospectus.png" width="980" height="307" />
		</div>
	    <div class="row">
            <div class="col-md-10">
                <h1 class="law-header">Alternative Prospectus</h1>
                <?PHP
                $number=1;
                $category=18;
                ...
                <iframe src="https://docs.google.com/file/d/0Bw8SIdDpHSlJb1k0QTdJTXp0d0k/preview" width="946" height="600"></iframe>

...
<body>
    ...
    <div class="container">
		<div>
			<img class="img-responsive" src="images/banner_seniornegs.png" width="980" height="307" />
		</div>
	    <div class="row">
            <div class="col-md-10">
                <a href="competitions.php"><h4>&lt; Back</h4></a>
                <h1 class="law-header">Shearman &amp; Sterling Senior Negotiations Competition</h1>
				<?PHP
					$number=1;
					$category=14;

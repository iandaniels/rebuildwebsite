...
<table width="1061" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="982"><table width="980" border="0" cellspacing="0">
      <tr>
        <td><img src="images/banner_clientinterviewing.png" width="980" height="307" /></td>
      </tr>
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="5">
          <tr>
            <td><table width="100%" border="0" cellspacing="10">
              ...
              <tr>
                <td height="18"><p align="justify" style="line-height:150%"><img src="images/text_comp_clientinterviewing.png" width="700" height="16" /><br />
                </p></td>
              </tr>
              <tr>
                <td><?PHP

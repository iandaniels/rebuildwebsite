...
function echofooter(){
    ...
    $skin_footer = preg_replace("/{copyrights}/", "<div style='font-size: 9px'>Powered by <a style='font-size: 9px' href=\"http://cutephp.com/cutenews/\" target=_blank>$config_version_name</a> � 2005  <a style='font-size: 9px' href=\"http://cutephp.com/\" target=_blank>CutePHPf</a>.</div>", $skin_footer);

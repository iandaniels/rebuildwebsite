...
<p style="line-height:150%"><font face="Arial, Helvetica, sans-serif" color="#319BC3" size="3"><strong>{title}</strong><br>
</font><font face="Arial, Helvetica, sans-serif" color="#333333" size="-1">{short-story}<br>
</font></p>
HTML;
